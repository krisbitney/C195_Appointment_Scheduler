...
public class AppointmentDaoImp implements AppointmentDao {
        ...
        String query = "select appointmentId, customerId, userId, title, description, location, contact, type, url, start, end from appointment";
            try {
                ...
                while (resultSet.next()) {
                    ...
                    LocalDateTime start = resultSet.getTimestamp("start").toLocalDateTime().atZone(DbConnector.DB_TIME_ZONE).withZoneSameInstant(UserSettings.USER_TIME_ZONE).toLocalDateTime();
                    LocalDateTime end = resultSet.getTimestamp("end").toLocalDateTime().atZone(DbConnector.DB_TIME_ZONE).withZoneSameInstant(UserSettings.USER_TIME_ZONE).toLocalDateTime();
    ...
    public ObservableList<Appointment> getAppointmentsOverlappingInterval(LocalDateTime intervalStart, LocalDateTime intervalEnd, int userId) {
        ...
        try {
            PreparedStatement ps = DbConnector.getInstance().connection().prepareStatement(query);
            ps.setInt(1, userId);
            ps.setTimestamp(2, java.sql.Timestamp.valueOf(intervalEnd.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ps.setTimestamp(3, java.sql.Timestamp.valueOf(intervalStart.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ResultSet resultSet = ps.executeQuery();
            while (resultSet.next()) {
                int appointmentId = resultSet.getInt("appointmentId");
                int customerId = resultSet.getInt("customerId");
    ...
    public ObservableList<Appointment> getAppointmentsStartingInInterval(LocalDateTime intervalStart, LocalDateTime intervalEnd, int userId) {
        ...
        try {
            PreparedStatement ps = DbConnector.getInstance().connection().prepareStatement(query);
            ps.setInt(1, userId);
            ps.setTimestamp(2, java.sql.Timestamp.valueOf(intervalStart.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ps.setTimestamp(3, java.sql.Timestamp.valueOf(intervalEnd.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ResultSet resultSet = ps.executeQuery();
            while (resultSet.next()) {
                int appointmentId = resultSet.getInt("appointmentId");
                int customerId = resultSet.getInt("customerId");
    ...
    public boolean updateAppointment(Appointment appointment) {
        ...
        try {
            ...
            ps.setTimestamp(9, java.sql.Timestamp.valueOf(appointment.getStart().atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ps.setTimestamp(10, java.sql.Timestamp.valueOf(appointment.getEnd().atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
    ...
    public boolean updateAppointment(int appointmentId, int customerId, int userId, String title, String description, String location, String contact, String type, String url, LocalDateTime start, LocalDateTime end) {
        ...
        try {
            ...
            ps.setString(7, type);
            ps.setString(8, url);
            ps.setTimestamp(9, java.sql.Timestamp.valueOf(start.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ps.setTimestamp(10, java.sql.Timestamp.valueOf(end.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ps.setString(11, UserSettings.userName);
    ...
    public Appointment addAppointment(int customerId, int userId, String title, String description, String location, String contact, String type, String url, LocalDateTime start, LocalDateTime end) {
        ...
        try {
            ...
            ps.setString(8, type);
            ps.setString(9, url);
            ps.setTimestamp(10, java.sql.Timestamp.valueOf(start.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
            ps.setTimestamp(11, java.sql.Timestamp.valueOf(end.atZone(UserSettings.USER_TIME_ZONE).withZoneSameInstant(DbConnector.DB_TIME_ZONE).toLocalDateTime()));
